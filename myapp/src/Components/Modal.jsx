...
const Modal = ({email,action}) => {
  return (
    <div className="flex w-full h-full items-center justify-around p-3 rounded-md mb-4 shadow-md bg-stone-200">
      <div className="flex flex-col truncate">
        <span className="text-black font-semibold">blender model 1</span>
      </div>
      <button
  type="button"
